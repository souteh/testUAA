...
export class AgenceComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.agenceService
      ...
      .subscribe(
        (res: HttpResponse<IAgence[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInAgences(): void {
    this.eventSubscriber = this.eventManager.subscribe('agenceListModification', () => this.loadPage());
  }
