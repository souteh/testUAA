...
export class VoucherComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.voucherService
      ...
      .subscribe(
        (res: HttpResponse<IVoucher[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInVouchers(): void {
    this.eventSubscriber = this.eventManager.subscribe('voucherListModification', () => this.loadPage());
  }
