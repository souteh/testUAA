...
export class VilleComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.villeService
      ...
      .subscribe(
        (res: HttpResponse<IVille[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInVilles(): void {
    this.eventSubscriber = this.eventManager.subscribe('villeListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IVille[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
