...
export class VersionComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.versionService
      ...
      .subscribe(
        (res: HttpResponse<IVersion[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IVersion[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
