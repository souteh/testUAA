...
public class VilleResource {
     ...
     */
    @GetMapping("/villes")
    public ResponseEntity<List<Ville>> getAllVilles(VilleCriteria criteria, Pageable pageable) {
        log.debug("REST request to get Villes by criteria: {}", criteria);
        Page<Ville> page = villeQueryService.findByCriteria(criteria, pageable);
