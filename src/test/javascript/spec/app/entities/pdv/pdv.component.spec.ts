...
import { PdvComponent } from 'app/entities/pdv/pdv.component';
import { PdvService } from 'app/entities/pdv/pdv.service';
import { Pdv } from 'app/shared/model/pdv.model';

describe('Component Tests', () => {
  describe('Pdv Management Component', () => {
    let comp: PdvComponent;
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.pdvs && comp.pdvs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
