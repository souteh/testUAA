...
import { TypepdvComponent } from 'app/entities/typepdv/typepdv.component';
import { TypepdvService } from 'app/entities/typepdv/typepdv.service';
import { Typepdv } from 'app/shared/model/typepdv.model';

describe('Component Tests', () => {
  describe('Typepdv Management Component', () => {
    let comp: TypepdvComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TypepdvComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.typepdvs && comp.typepdvs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
