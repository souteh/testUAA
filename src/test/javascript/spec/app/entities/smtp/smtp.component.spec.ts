...
import { SmtpComponent } from 'app/entities/smtp/smtp.component';
import { SmtpService } from 'app/entities/smtp/smtp.service';
import { Smtp } from 'app/shared/model/smtp.model';

describe('Component Tests', () => {
  describe('Smtp Management Component', () => {
    let comp: SmtpComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SmtpComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.smtps && comp.smtps[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
