...
import { AlertemailComponent } from 'app/entities/alertemail/alertemail.component';
...
describe('Component Tests', () => {
  describe('Alertemail Management Component', () => {
    let comp: AlertemailComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AlertemailComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.alertemails && comp.alertemails[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
