...
import { TypeterminalComponent } from 'app/entities/typeterminal/typeterminal.component';
...
describe('Component Tests', () => {
  describe('Typeterminal Management Component', () => {
    let comp: TypeterminalComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TypeterminalComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.typeterminals && comp.typeterminals[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
