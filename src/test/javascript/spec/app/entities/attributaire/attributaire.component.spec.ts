...
import { AttributaireComponent } from 'app/entities/attributaire/attributaire.component';
...
describe('Component Tests', () => {
  describe('Attributaire Management Component', () => {
    let comp: AttributaireComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AttributaireComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.attributaires && comp.attributaires[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
